...
func createSecVFIcon(size: CGSize) -> NSImage {
...
func saveIconSet() {
    ...
    let iconsetPath = "/Users/daxxsec/Code/Sandboxes/SecVF/SecVF.iconset"
    ...
    for (baseSize, scale, name) in sizes {
        ...
        let image = createSecVFIcon(size: CGSize(width: CGFloat(pixelSize), height: CGFloat(pixelSize)))
    ...
    task.arguments = ["-c", "icns", iconsetPath, "-o", "/Users/daxxsec/Code/Sandboxes/SecVF/SecVF.icns"]
    task.launch()
    task.waitUntilExit()
