...
class SplashScreenWindow: NSWindow {
    ...
    private func setupUI() {
        ...
        logoImageView.image = createsecurityLogo()
        ...
        subtitleLabel.textColor = NSColor(red: 0.5, green: 0.7, blue: 0.75, alpha: 1.0)
        subtitleLabel.alphaValue = 0
        contentView.addSubview(subtitleLabel)

        // Version/Loading label - Neon green
        ...
        versionLabel.textColor = NSColor(red: 0.0, green: 1.0, blue: 0.5, alpha: 1.0)  // Neon green
    ...
    private func createsecurityLogo() -> NSImage {
